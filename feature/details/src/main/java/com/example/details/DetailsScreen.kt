...
import com.example.details.components.DetailsContent
import com.example.details.components.DetailsTopAppBar
...
fun ZoomableImage(
    ...
    Box(
        ...
        HorizontalPager(pageCount = galleryImages().size) { galleryIndex ->
            AsyncImage(
                modifier = Modifier
                    .fillMaxSize()
                    .graphicsLayer(
                ...
                model = ImageRequest.Builder(context)
                    .data(galleryImages()[galleryIndex].image)
                    .crossfade(true)
                    .build(),
